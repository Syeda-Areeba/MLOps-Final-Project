...
def git_commit():
    os.chdir('/opt/airflow/DVC')
    os.system('git add .')
    os.system('git commit -m "Updated weather data and pushed to DVC"')
    os.system('git push')

with DAG("my_dag", start_date=datetime(2024, 1, 1), schedule_interval="@hourly", catchup=False) as dag:
